...
<html lang="en">
  <head>
    <title>Luke Greenberg Portfolio</title>
    <meta charset="utf-8">
	          ...
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
			            ...
			            <h1 class="mb-4 mt-3">I'm <span>Luke Greenberg</span></h1>
			            <h2 class="mb-4" style="color:grey">A BIT Student and Software Developer</h2>
		            </div>
		          </div>
	        	</div>
	        </div>
	      ...
	      <div class="slider-item">
	        ...
	        <div class="container">
	          <div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
			            <h1 class="mb-4 mt-3">A <span>software developer</span> from South Africa</h1>
		            </div>
		          </div>
	        	</div>
	        </div>
    		...
    		<div class="row d-flex">
    			...
    			<div class="col-md-6 col-lg-7 pl-lg-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <p>Born in South Africa, schooled at The King's College in Bryanston and further education at the University of Pretoria. Studying BIT and moving into BIT (Hons) with a specialisation in AI.</p>
		          </div>
		        </div>
		        <div class="row">
		        	<div class="col-md-6">
		              ...
		              <div class="media-body">
		                <h3 class="heading mb-3">Backend Developer</h3>
		                <p>Experienced in python and Django environments to create APIs and backend microservices.</p>
		              </div>
		            </div> 
		        	</div>
		        	<div class="col-md-6">
		              ...
		              <div class="media-body">
		                ...
		                <p>Experienced in front end and mobile applications including the ability to use React, its native sister and Angular</p>
		              </div>
		            </div> 
		        	</div>
		        </div>
    ...
    <section class="ftco-section ftco-project" id="projects-section">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <p>A little bit of what I have done in my career</p>
          </div>
        </div>
    		<div class="row">
    			<div class="col-md-8">
